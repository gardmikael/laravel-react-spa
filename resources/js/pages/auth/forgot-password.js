	...
	return (
		<div className="flex justify-center items-center w-full py-4 flex-col min-h-screen bg-gray-200">
		{
				...
				>
					<div className="mb-4 mt-3">
						...
						<div className="mt-6 pt-6 border-t border-grey-light">
							<strong className="text-gray-700">Finner du ikke eposten</strong>
							<div className="text-gray-600 text-sm pt-2">
								Sjekk spamfilteret ditt ettert epost fra support@myapp.com
							</div>
						</div>
					</div>
				</form>
			...
			<div className="py-4 font-bold text-sm text-gray-700">
				<span className="text-gray-600">Obs, gå
					<Link
						to="/login"
						className="underline text-grey-darkest text-indigo"> tilbake
					</Link>
					&nbsp;til innloggingsiden.
				</span>
			</div>
